...
""" 
    ...
    USAGE EXAMPLE
        ...
        python visualize_results_hrf.py -load_path C:\Users\Sunilkumar\Documents\GitHub\TextureDL\hrf\Model100\m_layer_7kernel_3iter__3.h5
...
def main():
    ...
    #load/create model
    dataFolderPath = os.getcwd() + '/hrf';
    modelFolder = dataFolderPath+'/Model100';
    ...
    topResults,bottomResults,im,label = e.evaluate_top_and_bottom_k(model=model,dataFolderPath=dataFolderPath,dataFolder='hrf_splitted_100',
                                                                    labelFolder='hrf_splitted_gt_100',k=1);
